 ...
 */
public class mallorca extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view =  inflater.inflate(R.layout.fragment_mallorca, container, false);
    ...
    private void getData(){
        ...
        Call<List<mallorcaAPI>> call = mallorcamain.getMallorcafootballteam().getmallorcaplayers();

        call.enqueue(new Callback<List<mallorcaAPI>>() {
            @Override
            public void onResponse(Call<List<mallorcaAPI>> call, Response<List<mallorcaAPI>> response) {
                ...
                List<mallorcaAPI> footballs =  response.body();

                for (mallorcaAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<mallorcaAPI>> call, Throwable t) {
