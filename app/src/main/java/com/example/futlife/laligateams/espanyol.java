 ...
 */
public class espanyol extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_espanyol, container, false);
    ...
    private void getData(){
        ...
        Call<List<espanyolAPI>> call = espanyolmain.getespanyolteam().getespanyolplayers();

        call.enqueue(new Callback<List<espanyolAPI>>() {
            @Override
            public void onResponse(Call<List<espanyolAPI>> call, Response<List<espanyolAPI>> response) {
                ...
                List<espanyolAPI> footballs =  response.body();

                for (espanyolAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<espanyolAPI>> call, Throwable t) {
