 ...
 */
public class leganes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view =inflater.inflate(R.layout.fragment_leganes, container, false);
    ...
    private void getData(){
        ...
        Call<List<leganesAPI>> call = leganesmain.getleganesteam().getleganesplayers();

        call.enqueue(new Callback<List<leganesAPI>>() {
            @Override
            public void onResponse(Call<List<leganesAPI>> call, Response<List<leganesAPI>> response) {
                ...
                List<leganesAPI> footballs =  response.body();

                for (leganesAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<leganesAPI>> call, Throwable t) {
