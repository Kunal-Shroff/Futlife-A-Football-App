 ...
 */
public class getafe extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_getafe, container, false);
    ...
    private void getData(){
        ...
        Call<List<getafeAPI>> call = getafemain.getgetafeteam().getgetafeplayers();

        call.enqueue(new Callback<List<getafeAPI>>() {
            @Override
            public void onResponse(Call<List<getafeAPI>> call, Response<List<getafeAPI>> response) {
                ...
                List<getafeAPI> footballs =  response.body();

                for (getafeAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<getafeAPI>> call, Throwable t) {
