 ...
 */
public class granada extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_granada, container, false);
    ...
    private void getData(){
        ...
        Call<List<granadaAPI>> call = granadamain.getgranadateam().getgranadaplayers();

        call.enqueue(new Callback<List<granadaAPI>>() {
            @Override
            public void onResponse(Call<List<granadaAPI>> call, Response<List<granadaAPI>> response) {
                ...
                List<granadaAPI> footballs =  response.body();

                for (granadaAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<granadaAPI>> call, Throwable t) {
