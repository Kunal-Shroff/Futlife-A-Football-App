...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_realmadrid, container, false);
    ...
    private void getData(){
        ...
        Call<List<realmadridAPI>> call = realmadridmain.getrealmadridteam().getrealmadridplayers();

        call.enqueue(new Callback<List<realmadridAPI>>() {
            @Override
            public void onResponse(Call<List<realmadridAPI>> call, Response<List<realmadridAPI>> response) {
                ...
                List<realmadridAPI> footballs =  response.body();

                for (realmadridAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<realmadridAPI>> call, Throwable t) {
