 ...
 */
public class realbetis extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_realbetis, container, false);
    ...
    private void getData(){
        ...
        Call<List<realbetisAPI>> call = realbetismain.getRealbetisteam().getrealbetisplayers();

        call.enqueue(new Callback<List<realbetisAPI>>() {
            @Override
            public void onResponse(Call<List<realbetisAPI>> call, Response<List<realbetisAPI>> response) {
                ...
                List<realbetisAPI> footballs =  response.body();

                for (realbetisAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<realbetisAPI>> call, Throwable t) {
