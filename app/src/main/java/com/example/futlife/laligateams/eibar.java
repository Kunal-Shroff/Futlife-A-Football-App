 ...
 */
public class eibar extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_eibar, container, false);
    ...
    private void getData(){
        ...
        Call<List<eibarAPI>> call = eibarmain.geteibarteam().geteibarplayers();

        call.enqueue(new Callback<List<eibarAPI>>() {
            @Override
            public void onResponse(Call<List<eibarAPI>> call, Response<List<eibarAPI>> response) {
                ...
                List<eibarAPI> footballs =  response.body();

                for (eibarAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<eibarAPI>> call, Throwable t) {
