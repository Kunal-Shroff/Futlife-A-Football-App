 ...
 */
public class celtavigo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_celtavigo, container, false);
    ...
    private void getData(){
        ...
        Call<List<celtavigoAPI>> call = celtavigomain.getceltavigoteam().getceltavigoplayers();

        call.enqueue(new Callback<List<celtavigoAPI>>() {
            @Override
            public void onResponse(Call<List<celtavigoAPI>> call, Response<List<celtavigoAPI>> response) {
                ...
                List<celtavigoAPI> footballs =  response.body();

                for (celtavigoAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<celtavigoAPI>> call, Throwable t) {
