...
private TextView textView;
    ...
    private void getData(){
        ...
        Call<List<barcelonaAPI>> call = barcelonamain.getbarcelonateam().getbarcelonaplayers();

        call.enqueue(new Callback<List<barcelonaAPI>>() {
            @Override
            public void onResponse(Call<List<barcelonaAPI>> call, Response<List<barcelonaAPI>> response) {
                ...
                List<barcelonaAPI> footballs =  response.body();

                for (barcelonaAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<barcelonaAPI>> call, Throwable t) {
