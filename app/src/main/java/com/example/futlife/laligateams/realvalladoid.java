 ...
 */
public class realvalladoid extends Fragment {


    public realvalladoid() {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_realvalladoid, container, false);
    ...
    private void getData(){
        ...
        Call<List<realvallaAPI>> call = realvallamain.getrealvallateam().getrealvallaplayers();

        call.enqueue(new Callback<List<realvallaAPI>>() {
            @Override
            public void onResponse(Call<List<realvallaAPI>> call, Response<List<realvallaAPI>> response) {
                ...
                List<realvallaAPI> footballs =  response.body();

                for (realvallaAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<realvallaAPI>> call, Throwable t) {
