 ...
 */
public class realsociedad extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_realsociedad, container, false);
    ...
    private void getData(){
        ...
        Call<List<realsociAPI>> call = realsocimain.getrealsociteam().getrealsociplayers();

        call.enqueue(new Callback<List<realsociAPI>>() {
            @Override
            public void onResponse(Call<List<realsociAPI>> call, Response<List<realsociAPI>> response) {
                ...
                List<realsociAPI> footballs =  response.body();

                for (realsociAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<realsociAPI>> call, Throwable t) {
