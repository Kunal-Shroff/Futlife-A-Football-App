 ...
 */
public class athleticclub extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_athleticclub, container, false);
    ...
    private void getData(){
        ...
        Call<List<athleticclubAPI>> call = athleticclubmain.getathelticclubteam().getathleticclubplayers();

        call.enqueue(new Callback<List<athleticclubAPI>>() {
            @Override
            public void onResponse(Call<List<athleticclubAPI>> call, Response<List<athleticclubAPI>> response) {
                ...
                List<athleticclubAPI> footballs =  response.body();

                for (athleticclubAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<athleticclubAPI>> call, Throwable t) {
