 ...
 */
public class sevilla extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_sevilla, container, false);
    ...
    private void getData(){
        ...
        Call<List<sevillaAPI>> call = sevillamain.getsevillateam().getsevillaplayers();

        call.enqueue(new Callback<List<sevillaAPI>>() {
            @Override
            public void onResponse(Call<List<sevillaAPI>> call, Response<List<sevillaAPI>> response) {
                ...
                List<sevillaAPI> footballs =  response.body();

                for (sevillaAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<sevillaAPI>> call, Throwable t) {
