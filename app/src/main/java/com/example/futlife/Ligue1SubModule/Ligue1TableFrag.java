 ...
 */
public class Ligue1TableFrag extends Fragment {


    public Ligue1TableFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ligue1_table, container, false);

        recyclerView = view.findViewById(R.id.recyclerviewLigue1Table);
    ...
    private void Getdata(){
        ...
        ligue1int ourRetrofit= retrofit.create(ligue1int.class);
    ...
    private void ShowIt(List<standingsConstructor> response) {
        ...
        ligue1Adapter adapter = new ligue1Adapter(response,getContext());
