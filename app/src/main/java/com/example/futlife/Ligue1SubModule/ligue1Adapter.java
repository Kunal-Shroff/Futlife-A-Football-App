...
public class ligue1Adapter extends RecyclerView.Adapter<standingsHolder> {

    private List<standingsConstructor> football;
    private Context context;

    public ligue1Adapter(List<standingsConstructor> list, Context context) {
        this.football = list;
    ...
    public standingsHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_ligue1_table,parent,false);
