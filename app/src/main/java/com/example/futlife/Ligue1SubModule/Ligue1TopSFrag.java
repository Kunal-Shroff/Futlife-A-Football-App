 ...
 */
public class Ligue1TopSFrag extends Fragment {


    public Ligue1TopSFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_ligue1_top, container, false);
        recyclerView = view.findViewById(R.id.card_recycler_viewLigue1Top);
    ...
    private void loadJSON() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        Ligue1TopInterface request = retrofit.create( Ligue1TopInterface .class);
