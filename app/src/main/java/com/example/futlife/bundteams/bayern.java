 ...
 */
public class bayern extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bayern, container, false);
    ...
    private void getData(){
        ...
        Call<List<bayernAPI>> call = bayernmain.getBayernfootballteam().getbayernplayers();

        call.enqueue(new Callback<List<bayernAPI>>() {
            @Override
            public void onResponse(Call<List<bayernAPI>> call, Response<List<bayernAPI>> response) {
                ...
                List<bayernAPI> footballs =  response.body();

                for (bayernAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<bayernAPI>> call, Throwable t) {
