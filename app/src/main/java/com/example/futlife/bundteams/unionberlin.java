 ...
 */
public class unionberlin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_unionberlin, container, false);
    ...
    private void getData(){
        ...
        Call<List<uberlinAPI>> call = uberlinmain.getuberlinteam().getuberlinplayers();

        call.enqueue(new Callback<List<uberlinAPI>>() {
            @Override
            public void onResponse(Call<List<uberlinAPI>> call, Response<List<uberlinAPI>> response) {
                ...
                List<uberlinAPI> footballs =  response.body();

                for (uberlinAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<uberlinAPI>> call, Throwable t) {
