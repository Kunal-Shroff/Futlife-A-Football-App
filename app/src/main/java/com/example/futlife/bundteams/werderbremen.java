 ...
 */
public class werderbremen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_werderbremen, container, false);
    ...
    private void getData(){
        ...
        Call<List<werderAPI>> call = werdermain.getWerderfootballteam().getwerderplayers();

        call.enqueue(new Callback<List<werderAPI>>() {
            @Override
            public void onResponse(Call<List<werderAPI>> call, Response<List<werderAPI>> response) {
                ...
                List<werderAPI> footballs =  response.body();

                for (werderAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<werderAPI>> call, Throwable t) {
