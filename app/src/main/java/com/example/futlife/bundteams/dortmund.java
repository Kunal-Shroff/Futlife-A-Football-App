...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_dortmund, container, false);
    ...
    private void getData(){
        ...
        Call<List<dortmundAPI>> call = dortmundmain.getDortmundfootballteam().getdortmundplayers();

        call.enqueue(new Callback<List<dortmundAPI>>() {
            @Override
            public void onResponse(Call<List<dortmundAPI>> call, Response<List<dortmundAPI>> response) {
                ...
                List<dortmundAPI> footballs =  response.body();

                for (dortmundAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<dortmundAPI>> call, Throwable t) {
