 ...
 */
public class frankfurt extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frankfurt, container, false);
    ...
    private void getData(){
        ...
        Call<List<frankfurtAPI>> call = frankfurtmain.getFrankfurtfootballteam().getfrankfurtplayers();

        call.enqueue(new Callback<List<frankfurtAPI>>() {
            @Override
            public void onResponse(Call<List<frankfurtAPI>> call, Response<List<frankfurtAPI>> response) {
                ...
                List<frankfurtAPI> footballs =  response.body();

                for (frankfurtAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<frankfurtAPI>> call, Throwable t) {
