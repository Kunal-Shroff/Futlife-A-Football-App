 ...
 */
public class dusseldorf extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dusseldorf, container, false);
    ...
    private void getData(){
        ...
        Call<List<dussAPI>> call = dussmain.getDussfootballteam().getdussplayers();

        call.enqueue(new Callback<List<dussAPI>>() {
            @Override
            public void onResponse(Call<List<dussAPI>> call, Response<List<dussAPI>> response) {
                ...
                List<dussAPI> footballs =  response.body();

                for (dussAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<dussAPI>> call, Throwable t) {
