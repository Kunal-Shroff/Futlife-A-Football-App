 ...
 */
public class augsburg extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_augsburg, container, false);
    ...
    private void getData(){
        ...
        Call<List<augsburgAPI>> call = augsburgmain.getAugsburgfootballteam().getaugsburgplayers();

        call.enqueue(new Callback<List<augsburgAPI>>() {
            @Override
            public void onResponse(Call<List<augsburgAPI>> call, Response<List<augsburgAPI>> response) {
                ...
                List<augsburgAPI> footballs =  response.body();

                for (augsburgAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<augsburgAPI>> call, Throwable t) {
