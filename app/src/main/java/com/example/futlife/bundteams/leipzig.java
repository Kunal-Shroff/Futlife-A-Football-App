 ...
 */
public class leipzig extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_leipzig, container, false);
    ...
    private void getData(){
        ...
        Call<List<leipzigAPI>> call = leipzigmain.getLeipzigfootballteam().getleipzigplayers();

        call.enqueue(new Callback<List<leipzigAPI>>() {
            @Override
            public void onResponse(Call<List<leipzigAPI>> call, Response<List<leipzigAPI>> response) {
                ...
                List<leipzigAPI> footballs =  response.body();

                for (leipzigAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<leipzigAPI>> call, Throwable t) {
