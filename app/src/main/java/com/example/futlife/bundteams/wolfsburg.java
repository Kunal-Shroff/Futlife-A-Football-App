 ...
 */
public class wolfsburg extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View view = inflater.inflate(R.layout.fragment_wolfsburg, container, false);
    ...
    private void getData(){
        ...
        Call<List<wolfsburgAPI>> call = wolfsburgmain.getWolfsburgfootballteam().getwolfsburgplayers();

        call.enqueue(new Callback<List<wolfsburgAPI>>() {
            @Override
            public void onResponse(Call<List<wolfsburgAPI>> call, Response<List<wolfsburgAPI>> response) {
                ...
                List<wolfsburgAPI> footballs =  response.body();

                for (wolfsburgAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<wolfsburgAPI>> call, Throwable t) {
