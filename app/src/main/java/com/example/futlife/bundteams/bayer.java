 ...
 */
public class bayer extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_bayer, container, false);
    ...
    private void getData(){
        ...
        Call<List<bayerAPI>> call = bayermain.getBayerfootballteam().getbayerplayers();

        call.enqueue(new Callback<List<bayerAPI>>() {
            @Override
            public void onResponse(Call<List<bayerAPI>> call, Response<List<bayerAPI>> response) {
                ...
                List<bayerAPI> footballs =  response.body();

                for (bayerAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<bayerAPI>> call, Throwable t) {
