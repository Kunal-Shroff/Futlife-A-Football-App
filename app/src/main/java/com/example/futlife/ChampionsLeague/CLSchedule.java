...
import com.example.futlife.PremierLeagueSubModule.PLfixtureInterface;
 ...
 */
public class CLSchedule extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=  inflater.inflate(R.layout.fragment_clschedule, container, false);

        recyclerView = view.findViewById(R.id.card_recycler_viewCLSchedule);
    ...
    private void loadJSON() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        CLScheduleInterface request = retrofit.create( CLScheduleInterface.class);
