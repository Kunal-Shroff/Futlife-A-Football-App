...
import com.example.futlife.PremierLeagueSubModule.PLtopInterface;
 ...
 */
public class CLTable extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cltable, container, false);
        recyclerView = view.findViewById(R.id.card_recycler_viewCLTop);
    ...
    private void loadJSON() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        CLTopInterface request = retrofit.create( CLTopInterface.class);
