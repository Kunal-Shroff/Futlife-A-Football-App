...
public class bundAdapter extends RecyclerView.Adapter<standingsHolder> {

    private List<standingsConstructor> football;
    private Context context;

    public bundAdapter(List<standingsConstructor> list, Context context) {
        this.football = list;
    ...
    public standingsHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_bltable,parent,false);
