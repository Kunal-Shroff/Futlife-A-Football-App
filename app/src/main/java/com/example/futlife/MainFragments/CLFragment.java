...
public class CLFragment extends Fragment {
    ...
    public CLPageAdapter pageAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_cl, container, false);
        ...
        viewPager = view.findViewById(R.id.viewpagerCL);

        ((MainActivity)getActivity()).getSupportActionBar().setTitle("ChampionsLeague");

        pageAdapter = new CLPageAdapter(getFragmentManager(),tabLayout.getTabCount());
