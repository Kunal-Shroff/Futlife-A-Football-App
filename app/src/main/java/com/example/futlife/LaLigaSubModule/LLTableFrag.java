 ...
 */
public class LLTableFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lltable, container, false);

        recyclerView = view.findViewById(R.id.recyclerviewLLTable);
    ...
    private void Getdata(){
        ...
        laligaSint ourRetrofit= retrofit.create(laligaSint.class);
    ...
    private void ShowIt(List<standingsConstructor> response) {
        ...
        laligaAdapter adapter = new laligaAdapter(response,getContext());
