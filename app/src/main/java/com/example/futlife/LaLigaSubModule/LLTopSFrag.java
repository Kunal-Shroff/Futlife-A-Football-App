 ...
 */
public class LLTopSFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lltop, container, false);

        recyclerView = view.findViewById(R.id.card_recycler_viewLLTop);
    ...
    private void loadJSON() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        LaLigaTopInterface request = retrofit.create( LaLigaTopInterface .class);
