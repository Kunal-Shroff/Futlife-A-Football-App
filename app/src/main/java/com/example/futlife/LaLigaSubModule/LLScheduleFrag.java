 ...
 */
public class LLScheduleFrag extends Fragment {


    public LLScheduleFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_llschedule, container, false);

        recyclerView = view.findViewById(R.id.card_recycler_viewLLSchedule);
    ...
    private void loadJSON() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        LaLigafixtureInterface request = retrofit.create( LaLigafixtureInterface.class);
