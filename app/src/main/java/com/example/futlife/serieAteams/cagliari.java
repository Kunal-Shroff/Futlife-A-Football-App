 ...
 */
public class cagliari extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cagliari, container, false);
    ...
    private void getData(){
        ...
        Call<List<cagliariAPI>> call = cagliarimain.getLillefootballteam().getlilleplayers();

        call.enqueue(new Callback<List<cagliariAPI>>() {
            @Override
            public void onResponse(Call<List<cagliariAPI>> call, Response<List<cagliariAPI>> response) {
                ...
                List<cagliariAPI> footballs =  response.body();

                for (cagliariAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<cagliariAPI>> call, Throwable t) {
