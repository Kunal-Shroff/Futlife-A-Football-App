...
public class juventus extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_juventus, container, false);
    ...
    private void getData(){
        ...
        Call<List<juventusAPI>> call = juventusmain.getsaintfootballteam().getsaintplayers();

        call.enqueue(new Callback<List<juventusAPI>>() {
            @Override
            public void onResponse(Call<List<juventusAPI>> call, Response<List<juventusAPI>> response) {
                ...
                List<juventusAPI> footballs =  response.body();

                for (juventusAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<juventusAPI>> call, Throwable t) {
