 ...
 */
public class genoa extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_genoa, container, false);
    ...
    private void getData(){
        ...
        Call<List<genoaAPI>> call = genoamian.getLillefootballteam().getlilleplayers();

        call.enqueue(new Callback<List<genoaAPI>>() {
            @Override
            public void onResponse(Call<List<genoaAPI>> call, Response<List<genoaAPI>> response) {
                ...
                List<genoaAPI> footballs =  response.body();

                for (genoaAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<genoaAPI>> call, Throwable t) {
