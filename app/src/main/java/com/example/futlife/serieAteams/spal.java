 ...
 */
public class spal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_spal, container, false);
    ...
    private void getData(){
        ...
        Call<List<spalAPI>> call = spalmain.getsaintfootballteam().getsaintplayers();

        call.enqueue(new Callback<List<spalAPI>>() {
            @Override
            public void onResponse(Call<List<spalAPI>> call, Response<List<spalAPI>> response) {
                ...
                List<spalAPI> footballs =  response.body();

                for (spalAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<spalAPI>> call, Throwable t) {
