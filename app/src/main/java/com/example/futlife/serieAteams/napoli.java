 ...
 */
public class napoli extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_napoli, container, false);
    ...
    private void getData(){
        ...
        Call<List<napoliAPI>> call = napolimain.getsaintfootballteam().getsaintplayers();

        call.enqueue(new Callback<List<napoliAPI>>() {
            @Override
            public void onResponse(Call<List<napoliAPI>> call, Response<List<napoliAPI>> response) {
                ...
                List<napoliAPI> footballs =  response.body();

                for (napoliAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<napoliAPI>> call, Throwable t) {
