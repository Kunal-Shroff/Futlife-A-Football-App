 ...
 */
public class sampdoria extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sampdoria, container, false);
    ...
    private void getData(){
        ...
        Call<List<sampdoriaAPI>> call = sampdoriamain.getsaintfootballteam().getsaintplayers();

        call.enqueue(new Callback<List<sampdoriaAPI>>() {
            @Override
            public void onResponse(Call<List<sampdoriaAPI>> call, Response<List<sampdoriaAPI>> response) {
                ...
                List<sampdoriaAPI> footballs =  response.body();

                for (sampdoriaAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<sampdoriaAPI>> call, Throwable t) {
