 ...
 */
public class lazio extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_lazio, container, false);
    ...
    private void getData(){
        ...
        Call<List<lazioAPI>> call = laziomain.getsaintfootballteam().getsaintplayers();

        call.enqueue(new Callback<List<lazioAPI>>() {
            @Override
            public void onResponse(Call<List<lazioAPI>> call, Response<List<lazioAPI>> response) {
                ...
                List<lazioAPI> footballs =  response.body();

                for (lazioAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<lazioAPI>> call, Throwable t) {
