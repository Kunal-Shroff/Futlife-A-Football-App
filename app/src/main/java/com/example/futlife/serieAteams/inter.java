 ...
 */
public class inter extends Fragment {
    ...
    private void getData(){
        ...
        Call<List<interAPI>> call = intermain.getsaintfootballteam().getsaintplayers();

        call.enqueue(new Callback<List<interAPI>>() {
            @Override
            public void onResponse(Call<List<interAPI>> call, Response<List<interAPI>> response) {
                ...
                List<interAPI> footballs =  response.body();

                for (interAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<interAPI>> call, Throwable t) {
