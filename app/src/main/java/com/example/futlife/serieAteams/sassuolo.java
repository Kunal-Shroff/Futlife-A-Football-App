 ...
 */
public class sassuolo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_sassuolo, container, false);
    ...
    private void getData(){
        ...
        Call<List<sassuoloAPI>> call = sassuolomain.getsaintfootballteam().getsaintplayers();

        call.enqueue(new Callback<List<sassuoloAPI>>() {
            @Override
            public void onResponse(Call<List<sassuoloAPI>> call, Response<List<sassuoloAPI>> response) {
                ...
                List<sassuoloAPI> footballs =  response.body();

                for (sassuoloAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<sassuoloAPI>> call, Throwable t) {
