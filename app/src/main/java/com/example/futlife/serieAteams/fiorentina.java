 ...
 */
public class fiorentina extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fiorentina, container, false);
    ...
    private void getData(){
        ...
        Call<List<fiorentinaAPI>> call = fiorentinamain.getLillefootballteam().getlilleplayers();

        call.enqueue(new Callback<List<fiorentinaAPI>>() {
            @Override
            public void onResponse(Call<List<fiorentinaAPI>> call, Response<List<fiorentinaAPI>> response) {
                ...
                List<fiorentinaAPI> footballs =  response.body();

                for (fiorentinaAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<fiorentinaAPI>> call, Throwable t) {
