 ...
 */
public class acmilan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_acmilan, container, false);
    ...
    private void getData(){
        ...
        Call<List<acmilanAPI>> call = acmilanmain.getLillefootballteam().getlilleplayers();

        call.enqueue(new Callback<List<acmilanAPI>>() {
            @Override
            public void onResponse(Call<List<acmilanAPI>> call, Response<List<acmilanAPI>> response) {
                ...
                List<acmilanAPI> footballs =  response.body();

                for (acmilanAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<acmilanAPI>> call, Throwable t) {
