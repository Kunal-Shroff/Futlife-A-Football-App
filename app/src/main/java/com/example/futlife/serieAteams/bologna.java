 ...
 */
public class bologna extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bologna, container, false);
    ...
    private void getData(){
        ...
        Call<List<bolognaAPI>> call = bolognamain.getLillefootballteam().getlilleplayers();

        call.enqueue(new Callback<List<bolognaAPI>>() {
            @Override
            public void onResponse(Call<List<bolognaAPI>> call, Response<List<bolognaAPI>> response) {
                ...
                List<bolognaAPI> footballs =  response.body();

                for (bolognaAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<bolognaAPI>> call, Throwable t) {
