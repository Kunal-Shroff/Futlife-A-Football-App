 ...
 */
public class udienese extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_udienese, container, false);
    ...
    private void getData(){
        ...
        Call<List<udineseAPI>> call = udinemain.getsaintfootballteam().getsaintplayers();

        call.enqueue(new Callback<List<udineseAPI>>() {
            @Override
            public void onResponse(Call<List<udineseAPI>> call, Response<List<udineseAPI>> response) {
                ...
                List<udineseAPI> footballs =  response.body();

                for (udineseAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<udineseAPI>> call, Throwable t) {
