...
public class Arsenal extends Fragment {
    ...
    private void getData(){
        ...
        Call<List<ArsenalAPI>> call = Arsenalmain.getarsenalteam().getarsenalplayers();

        call.enqueue(new Callback<List<ArsenalAPI>>() {
            @Override
            public void onResponse(Call<List<ArsenalAPI>> call, Response<List<ArsenalAPI>> response) {
                ...
                List<ArsenalAPI> footballs =  response.body();

                for (ArsenalAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<ArsenalAPI>> call, Throwable t) {
