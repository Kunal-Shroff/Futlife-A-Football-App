 ...
 */
public class sheffutd extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_sheffutd, container, false);
    ...
    private void getData(){
        ...
        Call<List<sheffutdAPI>> call = sheffutdmain.getsheffutdteam().getsheffutdplayers();

        call.enqueue(new Callback<List<sheffutdAPI>>() {
            @Override
            public void onResponse(Call<List<sheffutdAPI>> call, Response<List<sheffutdAPI>> response) {
                ...
                List<sheffutdAPI> footballs =  response.body();

                for (sheffutdAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<sheffutdAPI>> call, Throwable t) {
