 ...
 */
public class watford extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_watford, container, false);
    ...
    private void getData(){
        ...
        Call<List<watfordAPI>> call = watfordmain.getwatfordteam().getwatfordplayers();

        call.enqueue(new Callback<List<watfordAPI>>() {
            @Override
            public void onResponse(Call<List<watfordAPI>> call, Response<List<watfordAPI>> response) {
                ...
                List<watfordAPI> footballs =  response.body();

                for (watfordAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<watfordAPI>> call, Throwable t) {
