 ...
 */
public class astonvilla extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_astonvilla, container, false);
    ...
    private void getData(){
        ...
        Call<List<astonvillaAPI>> call = astonvillamain.getastonvillateam().getastonvillaplayers();

        call.enqueue(new Callback<List<astonvillaAPI>>() {
            @Override
            public void onResponse(Call<List<astonvillaAPI>> call, Response<List<astonvillaAPI>> response) {
                ...
                List<astonvillaAPI> footballs =  response.body();

                for (astonvillaAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<astonvillaAPI>> call, Throwable t) {
