 ...
 */
public class leicestercity extends Fragment {


    public leicestercity() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_leicestercity, container, false);
    ...
    private void getData(){
        ...
        Call<List<leicesterAPI>> call = leicestermain.getLeicesterteam().getleicesterplayers();

        call.enqueue(new Callback<List<leicesterAPI>>() {
            @Override
            public void onResponse(Call<List<leicesterAPI>> call, Response<List<leicesterAPI>> response) {
                ...
                List<leicesterAPI> footballs =  response.body();

                for (leicesterAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<leicesterAPI>> call, Throwable t) {
