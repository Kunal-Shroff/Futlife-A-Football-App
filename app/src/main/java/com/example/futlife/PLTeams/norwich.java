 ...
 */
public class norwich extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_norwich, container, false);
    ...
    private void getData(){
        ...
        Call<List<norwichAPI>> call = norwichmain.getnorwichteam().getnorwichplayers();

        call.enqueue(new Callback<List<norwichAPI>>() {
            @Override
            public void onResponse(Call<List<norwichAPI>> call, Response<List<norwichAPI>> response) {
                ...
                List<norwichAPI> footballs =  response.body();

                for (norwichAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<norwichAPI>> call, Throwable t) {
