...
public class mancity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mancity, container, false);
    ...
    private void getData(){
        ...
        Call<List<mancityAPI>> call = mancitymain.getmancityteam().getmancityplayers();

        call.enqueue(new Callback<List<mancityAPI>>() {
            @Override
            public void onResponse(Call<List<mancityAPI>> call, Response<List<mancityAPI>> response) {
                ...
                List<mancityAPI> footballs =  response.body();

                for (mancityAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<mancityAPI>> call, Throwable t) {
