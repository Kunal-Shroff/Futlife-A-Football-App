...
public class liverpool extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_liverpool, container, false);
    ...
    private void getData(){
        ...
        Call<List<liverpoolAPI>> call = liverpoolmain.getliverpoolteam().getliverpoolplayers();

        call.enqueue(new Callback<List<liverpoolAPI>>() {
            @Override
            public void onResponse(Call<List<liverpoolAPI>> call, Response<List<liverpoolAPI>> response) {
                ...
                List<liverpoolAPI> footballs =  response.body();

                for (liverpoolAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<liverpoolAPI>> call, Throwable t) {
