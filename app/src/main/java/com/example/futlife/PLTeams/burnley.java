 ...
 */
public class burnley extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_burnley, container, false);
    ...
    private void getData(){
        ...
        Call<List<burnleyAPI>> call = burnleymain.getburnleyteam().getburnleyplayers();

        call.enqueue(new Callback<List<burnleyAPI>>() {
            @Override
            public void onResponse(Call<List<burnleyAPI>> call, Response<List<burnleyAPI>> response) {
                ...
                List<burnleyAPI> footballs =  response.body();

                for (burnleyAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<burnleyAPI>> call, Throwable t) {
