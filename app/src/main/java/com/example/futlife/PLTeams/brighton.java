 ...
 */
public class brighton extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_brighton, container, false);
    ...
    private void getData(){
        ...
        Call<List<brightonAPI>> call = brightonmain.getbrightonteam().getbrightonplayers();

        call.enqueue(new Callback<List<brightonAPI>>() {
            @Override
            public void onResponse(Call<List<brightonAPI>> call, Response<List<brightonAPI>> response) {
                ...
                List<brightonAPI> footballs =  response.body();

                for (brightonAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<brightonAPI>> call, Throwable t) {
