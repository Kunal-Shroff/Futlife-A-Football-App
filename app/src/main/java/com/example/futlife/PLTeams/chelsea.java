...
public class chelsea extends Fragment {
    ...
    private void getData(){
        ...
        Call<List<chelseaAPI>> call = chelseamain.getchelseateam().getchelseaplayers();

        call.enqueue(new Callback<List<chelseaAPI>>() {
            @Override
            public void onResponse(Call<List<chelseaAPI>> call, Response<List<chelseaAPI>> response) {
                ...
                List<chelseaAPI> footballs =  response.body();

                for (chelseaAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<chelseaAPI>> call, Throwable t) {
