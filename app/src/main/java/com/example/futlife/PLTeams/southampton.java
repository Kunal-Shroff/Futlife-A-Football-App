 ...
 */
public class southampton extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_southampton, container, false);
    ...
    private void getData(){
        ...
        Call<List<southamptonAPI>> call = southamptonmain.getSouthamptonteam().getsouthamptonplayers();

        call.enqueue(new Callback<List<southamptonAPI>>() {
            @Override
            public void onResponse(Call<List<southamptonAPI>> call, Response<List<southamptonAPI>> response) {
                ...
                List<southamptonAPI> footballs =  response.body();

                for (southamptonAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<southamptonAPI>> call, Throwable t) {
