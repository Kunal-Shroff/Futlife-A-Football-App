 ...
 */
public class bournemouth extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_bournemouth, container, false);
    ...
    private void getData(){
        ...
        Call<List<bournemouthAPI>> call = bournemouthmain.getbournemouthteam().getbournemouthplayers();

        call.enqueue(new Callback<List<bournemouthAPI>>() {
            @Override
            public void onResponse(Call<List<bournemouthAPI>> call, Response<List<bournemouthAPI>> response) {
                ...
                List<bournemouthAPI> footballs =  response.body();

                for (bournemouthAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<bournemouthAPI>> call, Throwable t) {
