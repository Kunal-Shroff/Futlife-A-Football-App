...
public class serieaAdapter extends RecyclerView.Adapter<standingsHolder> {

    private List<standingsConstructor> football;
    private Context context;

    public serieaAdapter(List<standingsConstructor> list, Context context) {
        this.football = list;
    ...
    public standingsHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_satable,parent,false);
