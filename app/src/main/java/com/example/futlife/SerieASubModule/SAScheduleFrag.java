 ...
 */
public class SAScheduleFrag extends Fragment {


    public SAScheduleFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_saschedule, container, false);

        recyclerView = view.findViewById(R.id.card_recycler_viewSASchedule);
    ...
    private void loadJSON() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        SerieAfixtureInterface request = retrofit.create( SerieAfixtureInterface.class);
