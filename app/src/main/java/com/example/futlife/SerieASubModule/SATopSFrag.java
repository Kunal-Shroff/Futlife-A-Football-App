 ...
 */
public class SATopSFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_satop, container, false);

        recyclerView = view.findViewById(R.id.card_recycler_viewSATop);
    ...
    private void loadJSON() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        SerieATopInterface request = retrofit.create( SerieATopInterface .class);
