 ...
 */
public class strasbourg extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=  inflater.inflate(R.layout.fragment_strasbourg, container, false);
    ...
    private void getData(){
        ...
        Call<List<strasbourgAPI>> call = strasbourgmain.getstrasfootballteam().getstrasplayers();

        call.enqueue(new Callback<List<strasbourgAPI>>() {
            @Override
            public void onResponse(Call<List<strasbourgAPI>> call, Response<List<strasbourgAPI>> response) {
                ...
                List<strasbourgAPI> footballs =  response.body();

                for (strasbourgAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<strasbourgAPI>> call, Throwable t) {
