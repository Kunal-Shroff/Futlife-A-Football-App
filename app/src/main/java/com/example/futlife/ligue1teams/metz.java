 ...
 */
public class metz extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_metz, container, false);
    ...
    private void getData(){
        ...
        Call<List<metzAPI>> call = metzmain.getmetzfootballteam().getmetzplayers();

        call.enqueue(new Callback<List<metzAPI>>() {
            @Override
            public void onResponse(Call<List<metzAPI>> call, Response<List<metzAPI>> response) {
                ...
                List<metzAPI> footballs =  response.body();

                for (metzAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<metzAPI>> call, Throwable t) {
