 ...
 */
public class nimes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nimes, container, false);
    ...
    private void getData(){
        ...
        Call<List<nimesAPI>> call = nimesmain.getnimesfootballteam().getnimesplayers();

        call.enqueue(new Callback<List<nimesAPI>>() {
            @Override
            public void onResponse(Call<List<nimesAPI>> call, Response<List<nimesAPI>> response) {
                ...
                List<nimesAPI> footballs =  response.body();

                for (nimesAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<nimesAPI>> call, Throwable t) {
