 ...
 */
public class toulouse extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_toulouse, container, false);
    ...
    private void getData(){
        ...
        Call<List<toulouseAPI>> call = toulousemain.gettoulousefootballteam().gettoulouseplayers();

        call.enqueue(new Callback<List<toulouseAPI>>() {
            @Override
            public void onResponse(Call<List<toulouseAPI>> call, Response<List<toulouseAPI>> response) {
                ...
                List<toulouseAPI> footballs =  response.body();

                for (toulouseAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<toulouseAPI>> call, Throwable t) {
