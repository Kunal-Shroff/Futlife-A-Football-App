 ...
 */
public class lyon extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lyon, container, false);
    ...
    private void getData(){
        ...
        Call<List<lyonAPI>> call = lyonmain.getlyonfootballteam().getlyonplayers();

        call.enqueue(new Callback<List<lyonAPI>>() {
            @Override
            public void onResponse(Call<List<lyonAPI>> call, Response<List<lyonAPI>> response) {
                ...
                List<lyonAPI> footballs =  response.body();

                for (lyonAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<lyonAPI>> call, Throwable t) {
