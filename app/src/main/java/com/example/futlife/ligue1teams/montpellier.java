 ...
 */
public class montpellier extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_montpellier, container, false);
    ...
    private void getData(){
        ...
        Call<List<montAPI>> call = montmain.getmontfootballteam().getmontplayers();

        call.enqueue(new Callback<List<montAPI>>() {
            @Override
            public void onResponse(Call<List<montAPI>> call, Response<List<montAPI>> response) {
                ...
                List<montAPI> footballs =  response.body();

                for (montAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<montAPI>> call, Throwable t) {
