 ...
 */
public class nice extends Fragment {
    ...
    private void getData(){
        ...
        Call<List<niceAPI>> call = nicemain.getnicefootballteam().getniceplayers();

        call.enqueue(new Callback<List<niceAPI>>() {
            @Override
            public void onResponse(Call<List<niceAPI>> call, Response<List<niceAPI>> response) {
                ...
                List<niceAPI> footballs =  response.body();

                for (niceAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<niceAPI>> call, Throwable t) {
