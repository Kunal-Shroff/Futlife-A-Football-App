 ...
 */
public class lille extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lille, container, false);
    ...
    private void getData(){
        ...
        Call<List<lilleAPI>> call = lillemain.getLillefootballteam().getlilleplayers();

        call.enqueue(new Callback<List<lilleAPI>>() {
            @Override
            public void onResponse(Call<List<lilleAPI>> call, Response<List<lilleAPI>> response) {
                ...
                List<lilleAPI> footballs =  response.body();

                for (lilleAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<lilleAPI>> call, Throwable t) {
