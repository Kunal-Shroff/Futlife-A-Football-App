 ...
 */
public class dijon extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dijon, container, false);
    ...
    private void getData(){
        ...
        Call<List<dijonAPI>> call = dijonmain.getDijonfootballteam().getdijonplayers();

        call.enqueue(new Callback<List<dijonAPI>>() {
            @Override
            public void onResponse(Call<List<dijonAPI>> call, Response<List<dijonAPI>> response) {
                ...
                List<dijonAPI> footballs =  response.body();

                for (dijonAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<dijonAPI>> call, Throwable t) {
