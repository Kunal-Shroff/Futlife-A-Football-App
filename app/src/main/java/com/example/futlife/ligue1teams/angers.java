 ...
 */
public class angers extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_angers, container, false);
    ...
    private void getData(){
        ...
        Call<List<angersAPI>> call = angersmain.getangersfootballteam().getangersplayers();

        call.enqueue(new Callback<List<angersAPI>>() {
            @Override
            public void onResponse(Call<List<angersAPI>> call, Response<List<angersAPI>> response) {
                ...
                List<angersAPI> footballs =  response.body();

                for (angersAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<angersAPI>> call, Throwable t) {
