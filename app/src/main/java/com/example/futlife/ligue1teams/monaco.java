 ...
 */
public class monaco extends Fragment {
    ...
    private void getData(){
        ...
        Call<List<monacoAPI>> call = monacomain.getmonacofootballteam().getmonacoplayers();

        call.enqueue(new Callback<List<monacoAPI>>() {
            @Override
            public void onResponse(Call<List<monacoAPI>> call, Response<List<monacoAPI>> response) {
                ...
                List<monacoAPI> footballs =  response.body();

                for (monacoAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<monacoAPI>> call, Throwable t) {
