 ...
 */
public class rennes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=  inflater.inflate(R.layout.fragment_rennes, container, false);
    ...
    private void getData(){
        ...
        Call<List<rennesAPI>> call = rennesmain.getrennesfootballteam().getrennesplayers();

        call.enqueue(new Callback<List<rennesAPI>>() {
            @Override
            public void onResponse(Call<List<rennesAPI>> call, Response<List<rennesAPI>> response) {
                ...
                List<rennesAPI> footballs =  response.body();

                for (rennesAPI football : footballs
                ) {
            ...
            @Override
            public void onFailure(Call<List<rennesAPI>> call, Throwable t) {
