...
import com.example.futlife.ChampionsLeague.CLTopInterface;
 ...
 */
public class ELTopS extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_eltop, container, false);

        recyclerView = view.findViewById(R.id.card_recycler_viewELTop);
    ...
    private void loadJSON() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        ELTopInterface request = retrofit.create( ELTopInterface.class);
