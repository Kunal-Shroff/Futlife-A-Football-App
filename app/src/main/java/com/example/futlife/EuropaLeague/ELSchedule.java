...
import com.example.futlife.ChampionsLeague.CLScheduleInterface;
 ...
 */
public class ELSchedule extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_elschedule, container, false);

        recyclerView = view.findViewById(R.id.card_recycler_viewELSchedule);
    ...
    private void loadJSON() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        ELScheduleInterface request = retrofit.create( ELScheduleInterface.class);
